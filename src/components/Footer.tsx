	...
	return (
		<footer className="font-roboto-condensed bg-thirdgray py-4 px-4 md:px-8 xl:px-0">
			<div
				...
				<motion.div transition={{ duration: 1.5, delay: 0.25 }} whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: -100 }}
				...
				<motion.p transition={{ duration: 1.5, delay: 0.25 }} whileInView={{ opacity: 1, x: 0 }} initial={{ opacity: 0, x: 100 }}
